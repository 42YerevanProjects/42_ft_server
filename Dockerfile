...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/05/27 17:41:07 by shovsepy          #+#    #+#              #
#    Updated: 2021/05/27 17:41:13 by shovsepy         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
RUN openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout /etc/ssl/private/nginx-selfsigned.key -out /etc/ssl/certs/nginx-selfsigned.crt  -subj "/C=AM/ST=Yerevan/L=Yerevan/O=42 School/OU=shovsepy/CN=localhost" 
